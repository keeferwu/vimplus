...
vim.keymap.set({ "n", "v" }, "<leader>na", "<cmd>CodeCompanionActions<cr>", { noremap = true, silent = true })
vim.keymap.set({ "n", "v" }, "<leader>nc", "<cmd>CodeCompanionChat Toggle<cr>", { noremap = true, silent = true })
