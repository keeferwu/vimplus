...
let s:colors = {
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#5C6370", "cterm": "65", "cterm16": "7" }),
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#4B5263", "cterm": "238", "cterm16": "8" }),
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#2C323C", "cterm": "240", "cterm16": "0" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#3E4452", "cterm": "243", "cterm16": "8" }),
...
call s:h("Function", { "fg": s:blue, "cterm": "bold"}) " function name (also: methods for classes)
...
call s:h("Delimiter", { "fg": s:purple }) " character that needs attention
